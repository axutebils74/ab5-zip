...
Cheat_Menu.append_godmode_status = function() {
	...
	Cheat_Menu.append_cheat("状态:", status_text, 6, Cheat_Menu.god_mode_toggle);
};
...
Cheat_Menu.append_enemy_cheats = function(key1, key2, key3, key4) {
	Cheat_Menu.append_title("存活的");
	Cheat_Menu.append_cheat("敌人 HP 变 0", "执行", key1, Cheat_Menu.enemy_hp_cheat_1);
	Cheat_Menu.append_cheat("敌人 HP 变 1", "执行", key2, Cheat_Menu.enemy_hp_cheat_2);
	Cheat_Menu.append_title("全部");
	Cheat_Menu.append_cheat("敌人 HP 变 0", "执行", key3, Cheat_Menu.enemy_hp_cheat_3);
	Cheat_Menu.append_cheat("敌人 HP 变 1", "执行", key4, Cheat_Menu.enemy_hp_cheat_4);
};
...
Cheat_Menu.append_hp_cheats = function(key1, key2, key3, key4, key5, key6) {
	Cheat_Menu.append_title("存活的");
	Cheat_Menu.append_cheat("队伍 HP 变 0", "执行", key1, Cheat_Menu.party_hp_cheat_1);
	Cheat_Menu.append_cheat("队伍 HP 变 1", "执行", key2, Cheat_Menu.party_hp_cheat_2);
	Cheat_Menu.append_cheat("队伍回满血", "执行", key3, Cheat_Menu.party_hp_cheat_3);
	Cheat_Menu.append_title("全部");
	Cheat_Menu.append_cheat("队伍 HP 变 0", "执行", key4, Cheat_Menu.party_hp_cheat_4);
	Cheat_Menu.append_cheat("队伍 HP 变 1", "执行", key5, Cheat_Menu.party_hp_cheat_5);
	Cheat_Menu.append_cheat("队伍回满血", "执行", key6, Cheat_Menu.party_hp_cheat_6);
};
...
Cheat_Menu.append_mp_cheats = function(key1, key2, key3, key4, key5, key6) {
	Cheat_Menu.append_title("存活的");
	Cheat_Menu.append_cheat("队伍 MP 变 0", "执行", key1, Cheat_Menu.party_mp_cheat_1);
	Cheat_Menu.append_cheat("队伍 MP 变 1", "执行", key2, Cheat_Menu.party_mp_cheat_2);
	Cheat_Menu.append_cheat("队伍回满蓝", "执行", key3, Cheat_Menu.party_mp_cheat_3);
	Cheat_Menu.append_title("所有");
	Cheat_Menu.append_cheat("队伍 MP 变 0", "执行", key4, Cheat_Menu.party_mp_cheat_4);
	Cheat_Menu.append_cheat("队伍 MP 变 1", "执行", key5, Cheat_Menu.party_mp_cheat_5);
	Cheat_Menu.append_cheat("队伍回满蓝", "执行", key6, Cheat_Menu.party_mp_cheat_6);
};
...
Cheat_Menu.append_tp_cheats = function(key1, key2, key3, key4, key5, key6) {
	Cheat_Menu.append_title("存活的");
	Cheat_Menu.append_cheat("队伍 TP 变 0", "执行", key1, Cheat_Menu.party_tp_cheat_1);
	Cheat_Menu.append_cheat("队伍 TP 变 1", "执行", key2, Cheat_Menu.party_tp_cheat_2);
	Cheat_Menu.append_cheat("队伍回满TP", "执行", key3, Cheat_Menu.party_tp_cheat_3);
	Cheat_Menu.append_title("所有");
	Cheat_Menu.append_cheat("队伍 TP 变 0", "执行", key4, Cheat_Menu.party_tp_cheat_4);
	Cheat_Menu.append_cheat("队伍 TP 变 1", "执行", key5, Cheat_Menu.party_tp_cheat_5);
	Cheat_Menu.append_cheat("队伍回满TP", "执行", key6, Cheat_Menu.party_tp_cheat_6);
};
...
Cheat_Menu.append_no_clip_status = function(key1) {
	...
	Cheat_Menu.append_cheat("状态:", status_text, key1, Cheat_Menu.toggle_no_clip_status);
};
...
Cheat_Menu.append_party_state = function(key1) {
	Cheat_Menu.append_cheat("清除队伍状态", "执行", key1, Cheat_Menu.party_clear_states_cheat);
};

// append the clear actor state cheat to the menu
Cheat_Menu.append_current_state = function(key1) {
	Cheat_Menu.append_title("当前状态");
	var number_states = 0;
	...
	Cheat_Menu.append_cheat("数字效果:", number_states, key1, Cheat_Menu.clear_current_actor_states);
};
...
Cheat_Menu.append_switch_selection = function(key1, key2, key3) {
	...
	Cheat_Menu.append_cheat("状态:", current_switch_value, key3, Cheat_Menu.toggle_current_switch);
};
...
Cheat_Menu.append_save_recall = function (key1, key2, key3, key4, key5, key6) {
	...
	for (var i = 0; i < Cheat_Menu.saved_positions.length; i++) {
		Cheat_Menu.append_title("位置 " + (i+1));
		...
		Cheat_Menu.append_cheat("保存:", map_text, eval("key" + cur_key), Cheat_Menu.save_position.bind(null, i));
		cur_key++;

		Cheat_Menu.append_cheat("读取:", pos_text, eval("key" + cur_key), Cheat_Menu.recall_position.bind(null, i));
		cur_key++;
	}
};
...
Cheat_Menu.append_teleport = function (key1, key2, key3, key4, key5, key6, key7) {
	...
	Cheat_Menu.append_cheat("传送", "执行", key7, Cheat_Menu.teleport_current_location);
};
...
Cheat_Menu.menus.splice(0, 0, function() {
	Cheat_Menu.append_cheat_title("获取经验");
	Cheat_Menu.append_actor_selection(4, 5);
	Cheat_Menu.append_amount_selection(6, 7);
...
Cheat_Menu.menus.splice(0, 0, function() {
	Cheat_Menu.append_cheat_title("队伍 TP");

	Cheat_Menu.append_tp_cheats(4, 5, 6, 7, 8, 9);
});

Cheat_Menu.menus.splice(0, 0, function() {
	Cheat_Menu.append_cheat_title("队伍 MP");

	Cheat_Menu.append_mp_cheats(4, 5, 6, 7, 8, 9);
});

Cheat_Menu.menus.splice(0, 0, function() {
	Cheat_Menu.append_cheat_title("队伍 HP");

	Cheat_Menu.append_hp_cheats(4, 5, 6, 7, 8, 9);
});

Cheat_Menu.menus.splice(0, 0, function() {
	Cheat_Menu.append_cheat_title("敌人 HP");

	Cheat_Menu.append_enemy_cheats(4, 5, 6, 7);
});

Cheat_Menu.menus.splice(0, 0, function() {
	Cheat_Menu.append_cheat_title("穿墙");

	Cheat_Menu.append_no_clip_status(4);
});

Cheat_Menu.menus.splice(0, 0, function() {
	Cheat_Menu.append_cheat_title("上帝模式");
	Cheat_Menu.append_actor_selection(4, 5);

	Cheat_Menu.append_godmode_status();
});
Cheat_Menu.toggle_save = function() {
...
Cheat_Menu.menus.push(function(){
	Cheat_Menu.append_cheat_title("存读档");
	Cheat_Menu.append_cheat("存档", "执行", 4, function(){
		SceneManager.push(Scene_Save);
	});
	Cheat_Menu.append_cheat("读档", "执行", 5, function(){
